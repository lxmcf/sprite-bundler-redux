...
Config :: struct {
    ...
    export_atlas_as_png:             bool, // Export atlas as a PNG
    export_c_header:                 bool, // Export a C header with predefined enums for sprite ID's (only useful for supplied loader)
    export_raw_c:                    bool, // Export sprite and font info to raw C file (Will export atlas PNG)
    export_raw_odin:                 bool, // Export sprite and font info to raw Odin file (Will export atlas PNG)
}
